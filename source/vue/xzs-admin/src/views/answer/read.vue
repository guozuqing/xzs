  ...
  <el-container class="app-item-contain">
    <el-header class="align-center">
      ...
      <div>
        ...
        <span class="question-title-padding">试卷耗时：{{formatSecondsText(answer.doTime)}}</span>
      </div>
    </el-header>
    <el-main>
...
export default {
  ...
  methods: {
    formatSecondsText (theTime) {
      if (!theTime) return '0秒'
      let result = ''
      let hour = Math.floor(theTime / 3600)
      let minute = Math.floor((theTime - hour * 3600) / 60)
      let second = theTime - hour * 3600 - minute * 60
